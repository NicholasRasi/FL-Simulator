...
class FedProx(FedAlg):
    ...
    def init_optimizers(self):
        ...
        self.aggregator = {
            "fit": AggregationStrategyFactory.get_aggregation_strategy(self.config.algorithms["fit"]["aggregation"],
                                                                       self.status,
                                                                       self.config.algorithms["fit"]["data"],
                                                                       self.config, self.logger),
            "eval": AggregationStrategyFactory.get_aggregation_strategy(self.config.algorithms["eval"]["aggregation"],
                                                                        self.status,
                                                                        self.config.algorithms["eval"]["data"],
                                                                        self.config, self.logger)
        }
